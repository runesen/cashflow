...
pension_monthly_interest_rate = 0.02
...
fixed_expense = Expense(name="Fixed", monthly_amount=monthly_fixed_expenses)

leisure_expense = Expense(name="Leisure", monthly_amount=monthly_leisure_expenses)
